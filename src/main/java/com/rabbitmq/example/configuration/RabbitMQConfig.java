...
public class RabbitMQConfig {
     ...
     * direct binding to q5 when routing key is `log5`.
     ...
     * where exchange is `ayah.headers.exchange`.
     *
     * @return Binding
     */
     ...
     * where exchange is `ayah.headers.match.exchange`.
     *
     * @return Binding
     */
    ...
    /**
     * fanout binding to q1,q2,q3, and q4.
